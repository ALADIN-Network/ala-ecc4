...
function PrivateKey(d) {
    ...
    */
    function getChildKey(name) {
      // console.error('WARNING: getChildKey untested against alad'); // no alad impl yet
...
/**
    ...
    @arg {string} privateStr Alaio or Wallet Import Format (wif) -- a secret
*/
...
function unitTest() {
  ...
  assert.equal(pub.toString(), 'ALA859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM', pubError)
  // assert.equal(pub.toString(), 'PUB_K1_859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2Ht7beeX', pubError)
  // assert.equal(pub.toStringLegacy(), 'ALA859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM', pubError)
